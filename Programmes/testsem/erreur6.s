...
// Declaration de la variable bq
MOVZ x0, #1
SUB sp, sp, #16 // On décrémente le pointeur de pile 
STR x0, [sp] // On met la constante en pile 

// Instructions de la procédure erreur9
MOVZ x0, #1
SUB sp, sp, #16 // On décrémente le pointeur de pile 
STR x0, [sp] // On met la constante en pile 
...
// Opération
MOVZ x0, #24 // o Mise en pile depl var
MOVZ x1, #1 // o Mise en pile nb saut var
BL get_global_var // o Mise en pile var
STR x2, [sp, #0] // o Mise en pile var depuis le registre de retours des fonctions :)
MOVZ x0, #1
SUB sp, sp, #16 // On décrémente le pointeur de pile 
STR x0, [sp] // On met la constante en pile 
...
LDR x2, [sp] // On met la valeur de la variable droite dans x0 
SUB sp, sp, #16 // On décrémente le pointeur de pile 
MOVZ x0, #24 // On met le deplacement en pile 
